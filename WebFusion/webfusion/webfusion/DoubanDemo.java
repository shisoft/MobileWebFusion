...
public class DoubanDemo {
	...
	public static void main(String[] args) {
		// 授权过程
		String apiKey = "06c6004e22c0b9b6145200ea68422d22";
		String secret = "1f419fcc39a2663d";

		DoubanService myService = new DoubanService("麦丁网", apiKey, secret);
...
//		testMiniblogEntry(myService);
	...
	private static void testMiniblogEntry(DoubanService myService) {
		String userId = "62360997";
		MiniblogFeed mf;
		try {
			mf = myService.getUserMiniblogs(userId, 1, 10);

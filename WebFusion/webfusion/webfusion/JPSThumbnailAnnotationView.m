...
#define JPSThumbnailAnnotationViewShadowVisible     NO
...
- (void)setLayerProperties {
    ...
    if (JPSThumbnailAnnotationViewShadowVisible) {
        ...
        _strokeAndShadowLayer.shadowOffset = CGSizeMake (0, [[[UIDevice currentDevice] systemVersion] floatValue] >= 1.2 ? 1 : -1);

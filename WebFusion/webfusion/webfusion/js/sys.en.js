...
function prettyDate(time) {
    var time_formats = [
                        [60, 'Seconds', 1], // 60
                        [120, '1 Minute Ago', '1 Minutes To Now'], // 60*2
                        [3600, 'Minutes', 60], // 60*60, 60
                        [7200, '1 Hour Ago', '1 hour To Now'], // 60*60*2
                        [86400, 'Hours', 3600], // 60*60*24, 60*60
                        [172800, 'Yesterday', 'Tormorrow'], // 60*60*24*2
                        [604800, 'Days', 86400], // 60*60*24*7, 60*60*24
                        [1209600, '1 Week', '1 Week'], // 60*60*24*7*4*2
                        [2419200, 'Weeks', 604800], // 60*60*24*7*4, 60*60*24*7
                        [4838400, '1 Month', '1 Month'], // 60*60*24*7*4*2
                        [29030400, 'Month', 2419200], // 60*60*24*7*4*12, 60*60*24*7*4
                        [58060800, '1 Year', '1 Year'], // 60*60*24*7*4*12*2
                        [2903040000, 'Years', 29030400], // 60*60*24*7*4*12*100, 60*60*24*7*4*12
                        [5806080000, '1 Centry', '1 Centry'], // 60*60*24*7*4*12*100*2
                        [58060800000, 'Centries', 2903040000] // 60*60*24*7*4*12*100*20, 60*60*24*7*4*12*100
                        ];
